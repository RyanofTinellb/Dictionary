...
- <link>rel="icon" type="image/png" href="../data/assets/favicon.png"</link>
- <script>src="../data/scripts/search.js"</script>
- <script>src="../data/scripts/word_search.js"</script></head>
...
- elt.style.display = "block";}</inline-script>
- <script>src="search.js"</script>
- <internal-script>for (elt of document.getElementsByClassName(''javascript'')) {
- elt.style.display = "block";}</internal-script></body></html>
